<?php   
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO funcionario(funcionario_id, nome, cargo, salario) VALUES ('$funcionario_id', '$nome', '$cargo', '$salario')");
    }
?>
<!DOCTYPE html>
<html lang="pt-br">
        ...
        <form action="funcionario.php" method="POST">
            <fieldset>
                ...
                <div class="inputBox">
                    ...
                    <label for="id" class="labelInput">ID do cliente</label>
                </div>
                <br><br>
                <div class="inputBox">
