<?php   
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO vendas(venda_id, nome, email, telefone) VALUES ('$venda_id', '$nome', '$email', '$telefone')");
    }
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
    ...
    <div class="box">
        <form action="historico-venda.php" method="POST">
            <fieldset>
                <legend><b>Histórico de vendas</b></legend>
                <div class="inputBox">
                    <input type="text" name="id" id="id" class="inputUser" required>
                    <label for="id" class="labelInput">ID da venda</label>
                </div>
                <br><br>
                <div class="inputBox">
